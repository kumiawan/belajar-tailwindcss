...
<html lang="en">
  <head>
    <title>Permohonan Izin Siswa</title>
    <meta charset="UTF-8">
    ...
    <div class="flex flex-row h-screen">
      ...
      <div class="flex flex-col w-full  mt-8 mr-16 rounded-lg bg-white h-full">
        ...
        <div class="flex p-4 justify-center items-center rounded-t-lg h-16 bg-[#575757] text-center font-bold text-white text-2xl">
          Permohonan Izin/Sakit/Dispen Siswa
        </div>
        <div class="flex flex-col h-full w-full p-24">
          ...
          <div class="h-full w-full">
            ...
            <div 
              ...
              <div 
                ...
                <div class="flex my-12 justify-evenly items-center">
                  <button 
                    onclick="permissionDenied('Berhasil ditolak',3000)"
            ...
            <div class="flex flex-row mb-3 p-2 justify-end">
              <button 
                type=""
                class="hidden justify-center items-center w-40 h-10 rounded-xl bg-green-500 text-white mr-4"
              >
                <a href="buat_absen.php"> Buat Absen</a>
              </button>
              <button 
                type="submit" 
