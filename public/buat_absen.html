				...
				<div class="flex flex-col justify-between bg-white m-7 w-96 h-screen rounded-lg text-xl p-4">
					<div class="">
						<ul>
							...
							<li class="flex ml-6 mb-4 text-white rounded-md 
								items-center font-semibold py-1 
								">
								<img src="assets/icon/play.png" alt="activity" class="w-4 h-4">
								<a href="tambah_data_siswa.html" 
									class="bg-white px-2 rounded-md 
									w-full h-8
									inline-block
									text-black
									hover:bg-gray-100
				...
				<div class="flex h-full w-full p-24">
					<form class="relative flex-col w-full">
						...
						<div class="flex-row mb-3 p-2">
							...
							<input type="time" name="" value="" class="border-2 border-green-500 mx-auto w-32">
							<input type="time" name="" value="" class="border-2 border-green-500 mx-auto w-32">
						</div>

						<!-- TODO BUAT DROP DOWN Tambah Siswa-->
						<div class="flex flex-row mb-3 p-2">
							<div class="w-60">
							<span class="font-semibold w-20 text-2xl inline-block">
								Tambah Siswa	
							</span>
							</div>
							<div class="flex flex-col w-1/2">
								<span class="text-gray-400 text-sm">
									Pilih untuk menambahkan Siswa
								</span>
								<input type="text" name="" value="" class="border-2 border-green-500 mx-auto w-full">
							</div>
						</div>
