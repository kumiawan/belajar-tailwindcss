    ...
    <nav>
      <div class="w-full mx-auto p-8 flex items-center justify-between">
        <div class="flex items-center">
          <img src="./assets/icon/logosmada.png" alt="logosmada" class="w-[84px]">
          ...
          <div class="col-span-1 ">
            <div class="w-[80px] h-38 mt-2 items-center rounded-r-[20px] border-r-4 border-slate-500 bg-green-500">
              <ul class="p-4 mx-auto place-self-center space-y-8">
                <li>
                  <a href="#twitter"><img src="./assets/icon/twitter.svg" alt="twitter" class="w-10"></a>
                </li>
                <li>
                  <a href="#facebook"><img src="./assets/icon/facebook.svg" alt="facebook" class="w-10"></a>
                </li>
                <li>
                  <a href="#instagram"><img src="./assets/icon/instagram.svg" alt="instagram" class="w-10"></a>
                </li>
                <li>
                  <a href="#youtube"><img src="./assets/icon/youtube.svg" alt="youtube" class="w-10"></a>
                </li>
              </ul>
            </div>
          </div>
